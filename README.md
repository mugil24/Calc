...
<head>
    ...
    <style>
        ...
        .button {
            ...
            margin-right: 550px;
            padding: 30px;
            background-color:rgb(72, 89, 215);
            color: white;
            border:5px solid rgb(20, 20, 20)
        }

        .button input[type="button"] {
            background-color:rgb(222, 145, 20);
            height: 50px;
            width: 50px;
            margin: 0 2px;
...
<body style="background-color:rgb(237, 92, 237);">
        <h1 align="center" style="color: aliceblue;">Vaanmugil VS</h1>
        <h1 align="center" style="color: aliceblue;">REGISTER NUMBER: 212221040174</h1>
        <div class="button">
            <center>
...
## OUTPUT:
![alt text](<Screenshot 2024-05-07 161743.png>)
![alt text](<Screenshot 2024-05-07 161800.png>)
## RESULT:
